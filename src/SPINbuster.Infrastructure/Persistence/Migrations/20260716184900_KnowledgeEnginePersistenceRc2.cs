...
{
  /// <inheritdoc />
  public partial class KnowledgeEnginePersistenceRc2 : Migration
  {
    /// <inheritdoc />
    protected override void Up(MigrationBuilder migrationBuilder)
    {
      ...
      migrationBuilder.CreateTable(
          ...
          constraints: table =>
          {
            ...
            table.ForeignKey(
                      name: "FK_knowledge_documents_knowledge_document_revisions_CurrentAuthoritativeRevisionId",
                      column: x => x.CurrentAuthoritativeRevisionId,
      ...
      migrationBuilder.CreateIndex(
          name: "IX_knowledge_document_revisions_KnowledgeDocumentId_CurrentAuthoritative",
      ...
      migrationBuilder.CreateIndex(
          name: "IX_knowledge_documents_CurrentAuthoritativeRevisionId",
          table: "knowledge_documents",
          column: "CurrentAuthoritativeRevisionId",
          unique: true);
