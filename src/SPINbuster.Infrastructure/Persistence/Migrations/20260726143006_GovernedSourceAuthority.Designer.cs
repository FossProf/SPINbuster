...
namespace SPINbuster.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260726143006_GovernedSourceAuthority")]
    partial class GovernedSourceAuthority
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SPINbuster.Infrastructure.Persistence.Records.KnowledgeDocumentRecord", b =>
                {
                    ...
                    b.HasIndex("ProjectId", "CanonicalIdentityHash")
                        .IsUnique();
            ...
            modelBuilder.Entity("SPINbuster.Infrastructure.Persistence.Records.KnowledgeRelationshipRecord", b =>
                {
                    ...
                    b.Property<Guid?>("SourceImportedSourceId")
                        .HasColumnType("TEXT");
                    ...
                    b.Property<Guid?>("TargetImportedSourceId")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("SPINbuster.Infrastructure.Persistence.Records.PromotionAttemptRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
                    ...
                    b.Property<Guid>("FragmentCandidateId")
                        .HasColumnType("TEXT");
                    ...
                    b.HasIndex("FragmentCandidateId");
            ...
            modelBuilder.Entity("SPINbuster.Infrastructure.Persistence.Records.PromotionDiagnosticRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
                    ...
                    b.Property<Guid?>("KnowledgeCitationId")
                        .HasColumnType("TEXT");

                    b.Property<Guid?>("KnowledgeDocumentId")
                        .HasColumnType("TEXT");

                    b.Property<Guid?>("KnowledgeDocumentRevisionId")
                        .HasColumnType("TEXT");
                    ...
                    b.Property<bool>("SupersededExistingRevision")
                        .HasColumnType("INTEGER");

                    b.Property<Guid?>("SupersededRevisionId")
                        .HasColumnType("TEXT");
                    ...
                    b.ToTable("promotion_diagnostics", (string)null);
                });

            modelBuilder.Entity("SPINbuster.Infrastructure.Persistence.Records.PromotionProvenanceRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
                    ...
                    b.Property<string>("FragmentSourceContentHash")
                        .IsRequired()
                        .HasColumnType("TEXT");

                    b.Property<string>("ImportedSourceContentHash")
                        .IsRequired()
                        .HasColumnType("TEXT");
                    ...
                    b.Property<long>("PromotedAtUtcTicks")
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<Guid>("PromotedRevisionId")
                        .HasColumnType("TEXT");

                    b.Property<Guid>("PromotionAttemptId")
                        .HasColumnType("TEXT");

                    b.Property<string>("PromotionIdentityHash")
                        .IsRequired()
                        .HasColumnType("TEXT");
                    ...
                    b.HasIndex("PromotedRevisionId")
                        .IsUnique();

                    b.ToTable("promotion_provenances", (string)null);
                });
            ...
            modelBuilder.Entity("SPINbuster.Infrastructure.Persistence.Records.PromotionDiagnosticRecord", b =>
                {
                    b.HasOne("SPINbuster.Infrastructure.Persistence.Records.FragmentCandidateRecord", null)
                        .WithMany()
                        .HasForeignKey("FragmentCandidateId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("SPINbuster.Infrastructure.Persistence.Records.PromotionProvenanceRecord", b =>
                {
                    b.HasOne("SPINbuster.Infrastructure.Persistence.Records.PromotionDiagnosticRecord", null)
                        .WithMany()
                    ...
                    b.HasOne("SPINbuster.Infrastructure.Persistence.Records.KnowledgeDocumentRevisionRecord", null)
                        .WithMany()
                        .HasForeignKey("PromotedRevisionId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                });
