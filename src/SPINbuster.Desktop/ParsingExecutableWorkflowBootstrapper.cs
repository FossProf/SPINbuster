...
public static class ParsingExecutableWorkflowBootstrapper
{
  public static async Task<ParsingExecutableWorkflowResult> RunAsync(
    ...
    CancellationToken cancellationToken = default)
  {
    ...
    var workflowRunner = scope.ServiceProvider.GetRequiredService<ParsingExecutableWorkflowRunner>();
