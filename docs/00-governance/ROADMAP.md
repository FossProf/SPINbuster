...
- Released governance package: `ENGINEERING-WORKFLOW-STANDARD-1.0` — releases the [Engineering Work Order Standard](ENGINEERING_WORK_ORDER_STANDARD.md) as the normative standard for future implementation work orders
...
- The governance package `ENGINEERING-WORKFLOW-STANDARD-1.0` was released; the Engineering Work Order Standard is adopted and normative for future implementation packages.
