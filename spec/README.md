...
- `spec/documents/` defines the Document Engine boundary, the released durable foundation, and the current executable review candidate for import, hashing, processing attempts, and non-authoritative candidates.
